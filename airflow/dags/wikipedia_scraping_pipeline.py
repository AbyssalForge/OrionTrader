    ...
    def notify_wikipedia(validation_result: dict):
        ...
        try:
            ...
            if webhook_discord_url:
                print("[NOTIFY] DISCORD_WEBHOOK trouvé, envoi notification...")
                ...
                print("[NOTIFY] DISCORD_WEBHOOK vide, notification ignorée")
                notification_result = {"status": "skipped", "reason": "No webhook"}

        except Exception as e:
            print(f"[NOTIFY] Pas de DISCORD_WEBHOOK configuré ({e}), notification ignorée")
