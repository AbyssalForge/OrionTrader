...
if [ -d "$VAULT_KEYS_FILE" ]; then
 echo " $VAULT_KEYS_FILE est un dossier, suppression..."
...
if [ ! -f "$VAULT_KEYS_FILE" ]; then
 ...
 echo " Fichier créé"
 echo ""
 echo " Le fichier est vide. Vous devez le remplir avec vos clés Vault :"
 ...
 echo " Le fichier existe mais ne contient pas les clés nécessaires"
